"""
LMS Integration for Unfolded Circle Remote Two/3.
...
async def main() -> None:
    ...
    from uc_intg_lmserver.driver import LMServerDriver
    from uc_intg_lmserver.setup_flow import LMServerSetupFlow

    driver = LMServerDriver()
    ...
    config_manager = BaseConfigManager(
        ...
        config_class=LMServerConfig,
    )
    driver.config_manager = config_manager

    setup_handler = LMServerSetupFlow.create_handler(driver)
    ...
    _LOG.info("LMS integration v%s started", __version__)
